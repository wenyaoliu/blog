...
var SettingTab = class extends import_obsidian5.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian5.Setting(settingsHighlights).setName("Custom text before all highlights").addText((text) => text.setValue(settings.highlightCustomTextBefore).onChange((value) => __async(this, null, function* () {
      console.log("highlightCustomTextBefore: " + value);
      settings.highlightCustomTextBefore = value;
      yield plugin.saveSettings();
    })));
    new import_obsidian5.Setting(settingsHighlights).setName("Custom text after all highlights").addText((text) => text.setValue(settings.highlightCustomTextAfter).onChange((value) => __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsComments).setName("Custom text before all comments").addText((text) => text.setValue(settings.commentCustomTextBefore).onChange((value) => __async(this, null, function* () {
      console.log("commentCustomTextBefore: " + value);
      settings.commentCustomTextBefore = value;
      yield plugin.saveSettings();
    })));
    new import_obsidian5.Setting(settingsComments).setName("Custom text after all comments").addText((text) => text.setValue(settings.commentCustomTextAfter).onChange((value) => __async(this, null, function* () {
  ...
  formatNoteElements(noteElements, citeKey) {
    ...
    for (let i = 0; i < noteElements.length; i++) {
        ...
        if (this.settings.imagesImport) {
          ...
          if (fs2.existsSync(pathImageOld) || fs2.existsSync(pathImageNew)) {
            if (this.settings.imagesCopy === false) {
              lineElements.rowEdited = "![](file:///" + pathImageOld + ")";
            } else {
      ...
      if (lineElements.annotationType === "typeMergeAbove") {
        noteElements[i].rowEdited = noteElements[i - 1].rowEdited + " ... " + this.settings.highlightCustomTextBefore + colourTextBefore + highlightFormatBefore + lineElements.highlightText + highlightFormatAfter + lineElements.citeKey + colourTextAfter;
...
${hashes} ` + lineElements.highlightText + lineElements.commentText + lineElements.zoteroBackLink;
      ...
      if (lineElements.annotationType == "typeTask") {
        if (lineElements.commentText !== "" && lineElements.highlightText !== "") {
          lineElements.rowEdited = `- [ ] ` + commentFormatBefore + lineElements.commentText + commentFormatAfter + " - " + colourTextBefore + highlightFormatBefore + lineElements.highlightText + highlightFormatAfter + lineElements.citeKey + colourTextAfter;
        } else if (lineElements.commentText == "" && lineElements.highlightColour !== "") {
          lineElements.rowEdited = `- [ ] ` + colourTextBefore + highlightFormatBefore + lineElements.highlightText + highlightFormatAfter + lineElements.citeKey + colourTextAfter;
        } else if (lineElements.commentText !== "" && lineElements.highlightColour === "") {
      ...
      if (lineElements.annotationType === "noKey") {
        ...
        if (lineElements.highlightText !== "") {
          ...
          if (lineElements.commentText !== "") {
            lineElements.rowEdited = lineElements.rowEdited + commentFormatBefore + lineElements.commentText + commentFormatAfter;
          }
